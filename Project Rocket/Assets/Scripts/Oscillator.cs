...
public class Oscillator : MonoBehaviour
{
    ...
    void Update()
    {
        if(period <= Mathf.Epsilon) { return; } //Floats are tricky and epsilon is the lowest float value compare to epislong and return instead of encapsulating the whole thing.
